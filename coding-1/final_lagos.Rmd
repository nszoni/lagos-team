...
#TODO: review caption, add kableExtra tabular form
...
#TODO: figure it out whether the charts are meaningful, how we can interpret it. change colors of the bars to match others, maybe move in the legend box within the chart to save space on the right
...
#TODO: add general makeup to the charts (e.g. labs, scaling of axis so its visually more appealing -- less chunky box, longer body.), harmonize colors, add visibility to the whiskers. Add annotation to extreme values.
