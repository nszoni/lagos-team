...
#TODO: I think, We should remove this one because it is quite the as the Scatterplot chart and the length of the html would be too long.
...
#TODO: Add annotation to extreme values
...
df_clean %>% 
  ...
  ggplot(aes(x = distance_from_city_centre_km, y = price_huf, color = factor(district))) +
    ...
    labs(x = "Distance from city centre",y = "Price",
          subtitle = "of Snickers 50g bar",
      title = "Price desnity by distance from city centre (HUF)",
      caption = "lagos-team") +
